...
async def test_that_a_message_can_be_inspected(
    ...
    assert len(iterations[0]["guideline_match_items"]) == 1
    assert iterations[0]["guideline_match_items"][0]["guideline_id"] == guideline.id
    assert iterations[0]["guideline_match_items"][0]["condition"] == guideline.content.condition
    assert iterations[0]["guideline_match_items"][0]["action"] == guideline.content.action
