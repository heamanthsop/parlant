...
JOURNEYS_DICT: dict[str, _JourneyData] = {
    "compliment_customer_journey": _JourneyData(
        ...
        steps=[
            ...
            _StepData(
                id="5",
                condition="the customer provided their phone number",
                action="send the customer a link to our terms of service page",
                follow_up_ids=["6"],
            ),
            _StepData(
                id="6",
                condition="The terms of service page was sent",
    ...
    "forgot_keys_journey": _JourneyData(
        ...
        steps=[
            ...
            _StepData(
                id="2",
                condition="The customer responded as to what type of keys they lost",
            ...
            _StepData(
                id="3",
                condition="The customer responds",
