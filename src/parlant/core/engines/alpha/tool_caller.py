...
>>>>>>> 5a36d0f0 (Add a comment for the old fields that left for decomentation)
...
Indicate the tool applicability with a boolean value: true if the tool is usefull at this point, or false if it is not.
...
{{
    ...
    "tool_calls_for_candidate_tool": [
        {{
            ...
            "is_applicable": <BOOL>,
            "argument_evaluations": [<EVALUATIONS FOR THE ARGUMENTS. CAN BE DROPPED ONLY IF THE IS NOT APPLICABLE>],
            "same_call_is_already_staged": <BOOL>,
...
>>>>>>> d641a082 (Remove should_run from tool caller output)
...
>>>>>>> 112dddf2 (Add a Few shot with a parameter of type list.)
]
