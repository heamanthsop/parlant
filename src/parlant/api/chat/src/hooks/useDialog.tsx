...
export const useDialog = (): UseDialogReturn => {
	...
	const DialogComponent = () => (
		<Dialog open={!!dialogContent}>
			<DialogPortal>
				<DialogContent data-testid='dialog' aria-hidden={false} style={{maxHeight: dialogSize.height, width: dialogSize.width}} className={'[&>button]:hidden !pointer-events-auto p-0 h-[80%] font-inter bg-white block max-w-[95%]'}>
