...
Parlant is an LLM-first conversational AI framework designed to provide developers with the control and precision they need over their user-facing AI agents, utilizing behavioral guidelines and runtime supervision. 🔧 🎛️ It's operated using an easy-to-use CLI 📟 and native client SDKs in Python and TypeScript 📦.
